...
<body>
    <div class="container" dir="rtl">
        <center>
            <div class="email-header">فرصتي</div>
        </center>
        <div class="email-container">
            ...
            <div class="email-footer">
                <p>
                    إذا كنت تواجه مشكلة في النقر فوق زر "إعادة تعيين كلمة المرور"، انسخ ولصق عنوان URL أدناه في متصفح
                    الويب
                    الخاص بك: <a
                        href="{{ $url ?? "" }}">{{ $url ?? "" }}</a>
                </p>
        ...
        <center>
            <div class="email-copyrit">© 2024 فرصتي. All rights reserved.</div>
        </center>
    </div>
</body>
